...
# We create a user to be able to login into our back office and test it
    ...
    joe = User.create!(email: "joe.ger@gmail.com", name: "Joe Ger", password: "password123")
    joe_address = Address.create!(street_address: "321 CodeBoxx Boulevard", city: "St. Pete", postal_code: "H4G52F")
